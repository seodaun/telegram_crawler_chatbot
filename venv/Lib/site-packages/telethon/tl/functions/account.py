...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputSecureValue, TypeInputPeerNotifySettings, TypeSecureCredentialsEncrypted, TypeReportReason, TypeSecureValueType, TypeAccountDaysTTL, TypeSecureValueHash, TypeInputPrivacyRule, TypeInputNotifyPeer, TypeBool, TypeInputPrivacyKey, TypeInputPeer
