...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelBannedRights, TypeInputChannel, TypeChannelAdminRights, TypeInputChatPhoto, TypeInputMessage, TypeInputUser, TypeChannelParticipantsFilter, TypeInputStickerSet, TypeBool, TypeChannelAdminLogEventsFilter
