...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputMessage, TypeInputSingleMedia, TypeShippingOption, TypeInputEncryptedChat, TypeReportReason, TypeInputStickeredMedia, TypeSendMessageAction, TypeInputChatPhoto, TypeInputMedia, TypeInputEncryptedFile, TypeInputBotInlineMessageID, TypeMessageEntity, TypeInputStickerSet, TypeMessagesFilter, TypeInputPeer, TypeInlineBotSwitchPM, TypeBool, TypeReplyMarkup, TypeInputBotInlineResult, TypeInputUser, TypeInputGeoPoint, TypeInputDocument, TypeInputDialogPeer
