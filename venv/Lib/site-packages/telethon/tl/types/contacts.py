...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactLink, TypeContact, TypeUser, TypePeer, TypePopularContact, TypeChat, TypeTopPeerCategoryPeers, TypeImportedContact, TypeContactBlocked
