...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeDialog, TypeUser, TypeStickerPack, TypeMessage, TypeChat, TypeStickerSet, TypeStickerSetCovered, TypeBotInlineResult, TypeFoundGif, TypeEncryptedFile, TypeHighScore, TypeDocument, TypeInlineBotSwitchPM, TypeChatFull
